...
?>
	...
	<body>
		<!-- preloader start -->
		<div class="preloader"> <img src="images/debate.gif" alt="preloader"> </div>
		<!-- preloader end -->
		<!-- header -->
					...
					<div class="modal-body">
						<div class="login">
							<form action="#" class="row">
								<div class="col-12">
									<input type="text" class="form-control mb-3" id="signupPhone" name="signupPhone" placeholder="Phone"> </div>
								<div class="col-12">
									<input type="text" class="form-control mb-3" id="signupName" name="signupName" placeholder="Name"> </div>
								<div class="col-12">
									<input type="email" class="form-control mb-3" id="signupEmail" name="signupEmail" placeholder="Email"> </div>
								<div class="col-12">
									<input type="password" class="form-control mb-3" id="signupPassword" name="signupPassword" placeholder="Password"> </div>
								<div class="col-12">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content rounded-0 border-0 p-4">
					...
					<div class="modal-body">
						<form action="#" class="row">
							<div class="col-12">
								<input type="text" class="form-control mb-3" id="loginPhone" name="loginPhone" placeholder="Phone"> </div>
							<div class="col-12">
								<input type="text" class="form-control mb-3" id="loginName" name="loginName" placeholder="Name"> </div>
							<div class="col-12">
								<input type="password" class="form-control mb-3" id="loginPassword" name="loginPassword" placeholder="Password"> </div>
							<div class="col-12">
			...
			<div class="container">
				<div class="row mob_res" style="margin-left: 0px;">
					<div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 des_hero">
						<div class="hero-slider ">
							...
							<div class="hero-slider-item">
								<div class="row">
									<div class="col-md-12">
										<h1 class="text-white" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".1">Want to have the most Influential Debate of all time? Battle it Out - 2v2 on the 17th of September 2022.</h1>
							...
							<div class="hero-slider-item">
								<div class="row">
									<div class="col-md-12">
										 <h1 class="text-white" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".1">Join us at the Vijaybhoomi University campus to develop your skills with expert sessions and fun activities! For Not For 2022, is back and this time it is BIGGER and BETTER. </h1><!-- <a href="register_closed.php?source=<?= $source ?>&medium=<?= $medium ?>&campaign=<?= $campaign ?>" class="btn btn-primary" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".7">Register now</a>-->
					...
					<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
						...
						<div class="col-md-12"><h1 class="text-white">Register Now</h1></div>
						<div class="col-md-12">
						...
						<!-- <a href="the-hybrid-british-parliamentary-debate-register.php" class="btn btn-primary" data-animation-out="fadeOutDown" data-delay-out="5" data-duration-in=".3" data-animation-in="zoomIn" data-delay-in=".7" tabindex="-1" style="opacity: 0; animation-delay: 5s; animation-duration: 0.3s;">Hybrid British Parliamentary Debate</a>--></div>
							...
							<!--  <a href="the-international-virtual-debate-register.php?source=<?= $source ?>&medium=<?= $medium ?>&campaign=<?= $campaign ?>" class="btn btn-primary" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".7">International Virtual Debate</a>-->
							 <!-- <a href="the-international-virtual-debate-register.php" class="btn btn-primary" data-animation-out="fadeOutDown" data-delay-out="5" data-duration-in=".3" data-animation-in="zoomIn" data-delay-in=".7" tabindex="-1" style="opacity: 0; animation-delay: 5s; animation-duration: 0.3s;">International Virtual Debate</a>--></div>
							  </div>
						...
						<div class="card">
							<div class="card-block p-3 card-one">
								<div class="row">											
									...
									<div class="col-md-10">
									<div class="fnfbox"><h4 class="card-title mb-0">FNF 2022 - The Hybrid British Parliamentary Debate from 
									September 17<sup>th</sup> to October 2<sup>nd</sup></h4></div>
									</div>
								</div>
								<ul class="objectives">
									<li>The Hybrid British Parliamentary Debate will be held in September 2022</li>
									<li>British Parliamentary Debate format</li>
									<li><i>Preliminary Rounds</i> will be held <b>virtually</b> on <b>17<sup>th</sup> and 18<sup>th</sup> September</b> where 32 teams will qualify to the Pre- Quarter round.</li>
									...
									<li>Students of Standard 11 and 12 from any school in India can participate. They have to be accompanied by a teacher.</li>
						...
						<div class="card retreat22">
							<div class="card-block p-3 card-two"> 
								<div class="row">											
									...
									<h4 class="card-title mb-0">FNF - Leadership Retreat from 30<sup>th</sup> Sept to 2<sup>nd</sup> Oct</h4></div></div>
							     </div>
							     <ul class="objectives">
					...
					<!--<div class="col-lg-4 col-sm-12">
						<div class="card">
							<div class="card-block p-3 card-three"> 
								...
								<ul class="objectives">
									<li>To cater for the interests of debate enthusiasts from across the globe we bring to you, FNF 2022- “Virtual International Debate”.</li>
						...
						<div class="card">
							<div class="card-block p-3 card-four"> 
								<div class="row">											
									...
									<div class="col-md-10">
									<div class="fnfbox" id="fbx"><h4 class="card-title mb-0">FNF - Initium</h4></div></div>
								</div>
								<ul class="objectives">
									...
									<li><i>Initium</i> 2022 is going to be bigger and better as we have a lot more exciting activities and workshops lined up for you. </li>
								</ul>
						...
						<div class="card">
							<div class="card-block p-3 card-three"> 
								<div class="row">											
									<div class="col-md-2"><i class="ti-user mb-0 feature-icon"></i></div>
									<div class="col-md-10">
									<div class="fnfbox" id="fbx"><h4 class="card-title mb-0">FNF 2022 Prizes</h4></div></div>
								</div>
								<ul class="objectives">
    ...
    padding: 25px">
		...
		<p>Never before seen in an international parliamentary debate competition of its size, For Not For 2022’s leadership retreat is sure to ease the competitive and tense environment, transitioning into one of fun and learning. The leadership retreat takes VBU’s best offerings and invites all those qualifying participants for an exciting and educative time at the VijayBhoomi University Campus. </p> -->
							<p class="mb-0"> <a href="leadership-retreat.php" class="card-link">Learn More</a> </div>
					</div>
...
<h2 class="text-center mb-5 test1">Testimonials</h2>
				...
				<a href="#" data-toggle="modal" data-target="#judge1"><img class="img-fluid w-100" style="opacity: 0.9;" src="images/judge-01.jpg" ><p class="btn w-100 click">Click here</p></a>
				</div>
				<div class="col-md-6 mb-5"><a href="#" data-toggle="modal" data-target="#judge2"><img class="img-fluid w-100" style="opacity: 0.9;" src="images/judge-02.jpg"><p class="btn w-100 click">Click here</p></a></div>
				
				<div class="col-md-6"><a href="#" data-toggle="modal" data-target="#fiona"><img class="img-fluid w-100" style="opacity: 0.9;" src="images/fiona-raj2.jpg" alt="about image"><p class="btn w-100 click">Click here</p></a></div>
				<div class="col-md-6">
				<a href="#" data-toggle="modal" data-target="#ratyansh"><img class="img-fluid w-100" style="opacity: 0.9;" src="images/ratyansh2.jpg" alt="about image"><p class="btn w-100 click">Click here</p></a></div>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/aarzu-malhotra.png"
                   alt="Aarzu Malhotra">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/advika-prasad.png"
                   alt="Advika Prasad">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/afrah-aneez.png"
                   alt="Afrah Aneez">
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/ahona-chakraborty.png"
                   alt="Ahona Chakraborty">
            </div>
          </div>

          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/anahita-singh.png"
                   alt="Anahita Singh">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/fiona-raj.png"
                   alt="Fiona Raj">
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/koiki-manning.png"
                   alt="Koiki Mmanning">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/lipi-bhansali.png"
                   alt="Lipi Bhansali">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/manasha-baral.png"
                   alt="Manasha Baral">
            </div>
          </div>
        </div>
    ...
    <!-- slide-->
      <div class="carousel-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/neal-jhawar.png"
                   alt="Neal Jhawar">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/ratyanash-garg.png"
                   alt="Ratyanash Garg">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/sam-sargam-sheetal.png"
                   alt="Sam Sargam Seetal">
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/shataaxi-chauhan.png"
                   alt="Shataaxi Chauhan">
            </div>
          </div>

          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/sourav-deb.png"
                   alt="Sourav Deb">
            </div>
          </div>
          ...
          <div class="col-md-4 clearfix d-none d-md-block">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/victoria-honoridez.png"
                   alt="Victoria Honoridez">
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="images/testimonial/yashwardhan-sharma.png"
                   alt="Yashwardhan Sharma">
            </div>
          </div>
    ...
    <div class="modal-content">
     ...
     <!-- <p>Fiona Raj, runner-up, from Shri Shikshayatan School said, “Not only did this platform give the youth a voice, but it also allowed us to present our voices in a way that was acceptable to the rest of the world. The judges' opinions and pointers allowed us to learn our strengths and weaknesses, which will help us for the rest of our lives. Debate competitions such as ForNotFor allow us to apply our knowledge and skills in real life.” </p> -->
	  ...
	  <iframe width="100%" height="315" src="https://www.youtube.com/embed/_89Yuf9NEgo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		<!--<a href="register_closed.php?source=<?= $source ?>&medium=<?= $medium ?>&campaign=<?= $campaign ?>" target="_blank">
			<button class="btn scroll" id="scroll">Register Now </button>
		</a>-->
		<script>

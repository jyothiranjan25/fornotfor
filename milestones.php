		...
		<div class="row text-center">
			<div class="col">
				<div class="counter1"> <i class="fa fa-graduation-cap fa-5x" aria-hidden="true"></i>
					<h2 class="timer count-title1 count-number" data-to="272" data-speed="7000">₹</h2>
			...
			<div class="col">
				<div class="counter1"> <i class="fa fa-globe fa-5x" aria-hidden="true"></i>
					<h2 class="timer count-title1 count-number" data-to="6" data-speed="7000"></h2>
					<p class="count-text ">Countries</p>
				</div>
			</div>
			<div class="col">
				<div class="counter1"> <i class="fa fa-university fa-5x" aria-hidden="true"></i>
					<h2 class="timer count-title1 count-number" data-to="88" data-speed="7000"></h2>

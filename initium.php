      ...
      <div class="row mb-5">
        <div class="col-12">
          ...
          <ul class="objectives">
            ...
            <li>Now, what does 2023 have in store for us? <i>Initium</i> 2023 is going to be bigger and better as we have a lot more exciting activities and workshops lined up for you. We aim at expanding not only the number of activities conducted but also bring in a plethora of other interesting events that would help in bringing out the excitement and also break the ice among participants. Initium 2023 may not require the hard-driven competitive spirit such as For Not For, but it certainly calls for its own unique sportsmanship and cadre which excites one from within.</li>
          </ul>
        </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <h2 class="section-title mt-5">Calendar of Events for FNF 2023 to be updated soon</h2>
        </div>
        <div class="col-12">
